...
public final class MemoryData {
    ...
    public static void saveProfilePic(String data, Context context) {
        try {
            FileOutputStream fileOutputStream = context.openFileOutput ("urlpic.txt", Context.MODE_PRIVATE);
            fileOutputStream.write (data.getBytes ());
            fileOutputStream.close();
        }   catch (IOException e) {
            e.printStackTrace();
    ...
    public static String getProfilePic (Context context) {
        String data = "";
        try {
            FileInputStream fis = context.openFileInput ("urlpic.txt");
            InputStreamReader isr = new InputStreamReader(fis);
            BufferedReader bufferedReader = new BufferedReader (isr);
            StringBuilder sb = new StringBuilder ();
            String line;
